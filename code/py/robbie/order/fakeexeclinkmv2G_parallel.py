...
class ExecLink( object ):
    ...
    def cancelOrder( self, orderId, origOrderId, symbol, qty, tagVal=None ):
        with self._orderLock:
            return self._cancelOrder( orderId, origOrderId, symbol, qty, tagVal )
        
    def _cancelOrder( self, orderId, origOrderId, symbol, qty, tagVal=None ):
    ...
    def marketMoves(self, bidPriceSize, askPriceSize ):
        with self._orderLock:
            return self._marketMoves( bidPriceSize, askPriceSize )
        
    def _marketMoves(self, bidPriceSize, askPriceSize ):
        liveOrders = []
